						...
						if(res.data.type>0){
							...
							if(res.data.overtime>0){
								...
								if(res.data.subjump>0){
									var html = '<h1 class="mod-title"><span class="ico_log ico-'+paymethod+'"></span></h1><div class="mod-content" style="text-align: center;"><a href="'+res.data.subjumpurl+'" target="_blank"><img id="pay_qrcode_'+paymethod+'" src="'+res.data.qr+'" alt="'+res.data.payname+'二维码没出来？请用系统自带浏览器打开本站" width="230" height="230"></a>';
								}else{
									var html = '<h1 class="mod-title"><span class="ico_log ico-'+paymethod+'"></span></h1><div class="mod-content" style="text-align: center;"><img id="pay_qrcode_'+paymethod+'" src="'+res.data.qr+'" alt="'+res.data.payname+'二维码没出来？请用系统自带浏览器打开本站" width="230" height="230">';
								}
								html += '<div class="money-item">订单金额：<strong>￥'+res.data.money+'</strong></div>';
							    html += '<a href="'+res.data.subjumpurl+'" class="is-m" target="_blank">二维码不显示？点击此处购买</a>';
								html +='<div id="time-item_'+paymethod+'" class="time-item"><strong id="hour_show_'+paymethod+'"><s id="h"></s>0时</strong><strong id="minute_show_'+paymethod+'"><s></s>05分</strong><strong id="second_show_'+paymethod+'"><s></s>00秒</strong>';
								html +='<hr><p>请使用手机'+res.data.payname+'扫一扫</p><p>扫描二维码完成支付</p></div></div>';
							}else{
								if(res.data.subjump>0){
									var html = '<h1 class="mod-title"><span class="ico_log ico-'+paymethod+'"></span></h1><div class="mod-content" style="text-align: center;"><a href="'+res.data.subjumpurl+'" target="_blank"><img id="pay_qrcode" src="'+res.data.qr+'" alt="'+res.data.payname+'二维码没出来？请用系统自带浏览器打开本站" width="230" height="230"></a>';
								}else{
									var html = '<h1 class="mod-title"><span class="ico_log ico-'+paymethod+'"></span></h1><div class="mod-content" style="text-align: center;"><img id="pay_qrcode" src="'+res.data.qr+'" alt="'+res.data.payname+'二维码没出来？请用系统自带浏览器打开本站" width="230" height="230">';
								}
								html += '<div class="money-item">订单金额：<strong>￥'+res.data.money+'</strong></div>';
								html += '<a href="'+res.data.subjumpurl+'" class="is-m" target="_blank">二维码不显示？点击此处购买</a>';
