	...
	function converStatus(data){
		...
		switch(s)
		{
			...
			case '2':
				...
				str += ' <button class="view_kami layui-btn layui-btn-warm layui-btn-xs" data-orderid="'+data.orderid+'">查看账号</button>';
				break;
			default:
            ...
            success: function(res) {
                if (res.code == 1) {
					...
					layer.open({
						...
						,content: '<div style="padding: 20px"><p id="km">'+html+'</p></div>'
						,btn: ['复制账号','关闭']
						,btnAlign: 'c' //按钮居中
						,shade: 0 //不显示遮罩
						,yes: function(){
